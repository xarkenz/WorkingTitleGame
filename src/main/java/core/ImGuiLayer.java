...
public class ImGuiLayer {
    ...
    public void initImGui() {
        ...
        io.setIniFilename("imgui_window_config.ini"); // Save window configuration
        io.setConfigFlags(ImGuiConfigFlags.NavEnableKeyboard); // Navigation with keyboard
        io.setConfigFlags(ImGuiConfigFlags.DockingEnable); // Window docking
        ...
        glfwSetMouseButtonCallback(glfwWindow, (w, button, action, mods) -> {
            ...
            if (gameViewPanel.getWantCaptureMouse()) {
        ...
        if (new File("assets/fonts/roboto_medium.ttf").isFile()) {
            ...
            fontAtlas.addFontFromFileTTF("assets/fonts/roboto_medium.ttf", 16, fontConfig);
